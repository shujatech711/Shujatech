/**
   * Create By ༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽
   * Contact Me on 923485210711
*/
...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽', {
        font: 'Standard',
    ...
    console.log(chalk.green('   ༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽ 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting ༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽ system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽ bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽ BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽ тɛℓɛɢяαм вσт: Active') : chalk.red('❌༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽ тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ ༼〠⸙ՏᎻႮᎫᎪ ͲᎬᏟᎻ ᎷᎠ〠༽ system is ready and running!\n'));
    }
